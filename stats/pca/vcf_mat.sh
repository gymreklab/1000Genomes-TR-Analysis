...
zcat /projects/ps-gymreklab/helia/ensembl/ensemble_out/ensemble_chr"$chr"_filtered.vcf.gz | python3 /projects/ps-gymreklab/helia/ensembl/1000Genomes-TR-Analysis/stats/pca/vcf_mat.py $chr
